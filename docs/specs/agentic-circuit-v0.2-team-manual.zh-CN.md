# Agentic Circuit v0.2 团队 Specification 手册
...
| 机器可读清单 | [`opcodes-v0.2.json`](../../schemas/opcodes-v0.2.json) |
| 可执行示例 | [`examples/v02`](../../examples/v02/README.md) |

## 文档定位

本文帮助团队成员快速理解和使用 Agentic Circuit v0.2。它解释编程模型、
...
3. [v0.2 英文规范](agentic-circuit-v0.2.md)；
4. 本文和设计提案。
...
`ac.s8/s16/s32/s64`。ACIR v0.2 已冻结整数宽度，但尚未把有符号性作为完全独立的
类型语义；不要假设所有比较都自动采用 Python 的有符号规则。

可执行示例：
[`pyc_struct_pipeline.py`](../../examples/v02/pyc_struct_pipeline.py)。
...
可执行示例：
[`pyc_broadcast_pipeline.py`](../../examples/v02/pyc_broadcast_pipeline.py) 和
[`pyc_fork_pipeline.py`](../../examples/v02/pyc_fork_pipeline.py)。
...
可执行示例：
[`pyc_route_merge_pipeline.py`](../../examples/v02/pyc_route_merge_pipeline.py)。
...
可执行示例：
[`pyc_select_pipeline.py`](../../examples/v02/pyc_select_pipeline.py)。
...
可执行示例：
[`pyc_credit_pipeline.py`](../../examples/v02/pyc_credit_pipeline.py)。
...
可执行示例：
[`pyc_barrier_pipeline.py`](../../examples/v02/pyc_barrier_pipeline.py)。
...
完整参考：
[`davincioo_queue_model.py`](../../examples/v02/davincioo_queue_model.py)。该模型用公共
...
可执行示例：
[`pyc_recursive_pipeline.py`](../../examples/v02/pyc_recursive_pipeline.py)。
...
可执行示例：
[`pyc_conditional_pipeline.py`](../../examples/v02/pyc_conditional_pipeline.py)。
...
可执行示例：
[`pyc_feedback_pipeline.py`](../../examples/v02/pyc_feedback_pipeline.py) 和
[`pyc_loop_control_pipeline.py`](../../examples/v02/pyc_loop_control_pipeline.py)。
...
可执行示例：
[`pyc_firing_pipeline.py`](../../examples/v02/pyc_firing_pipeline.py)。
...
可执行示例：
[`gfsim_expect_pipeline.py`](../../examples/v02/gfsim_expect_pipeline.py)。
...
命令会检查 [`pyc-v0.2.lock.json`](../../toolchains/pyc-v0.2.lock.json)，执行 PYC
...
- [v0.2 英文规范](agentic-circuit-v0.2.md) 和本文对应入口。

不要把某个后端的实现细节提升成共享 ACIR 语义，也不要为 v0.1 增加别名。旧契约由
Git 历史和 release tag 保存。
...
1. 本文的“核心对象”和“最小示例”；
2. [`examples/v02/README.md`](../../examples/v02/README.md)；
3. [`davincioo_queue_model.py`](../../examples/v02/davincioo_queue_model.py)；
4. [v0.2 英文规范](agentic-circuit-v0.2.md)；
5. [`opcodes-v0.2.json`](../../schemas/opcodes-v0.2.json) 和
   [`test/ACIR`](../../test/ACIR)；
6. [v0.2 final audit](../implementation/v0.2-final-audit.md)。
