...
logic [8:0] pyc_constant_3; // op=pyc.constant
logic [7:0] a__jit_control_flow__L7; // pyc.name="a__jit_control_flow__L7"
logic [7:0] b__jit_control_flow__L8; // pyc.name="b__jit_control_flow__L8"
logic [7:0] pyc_add_4; // op=pyc.add
logic [6:0] pyc_extract_5; // op=pyc.extract
logic [7:0] pyc_zext_6; // op=pyc.zext
logic [7:0] x__jit_control_flow__L10; // pyc.name="x__jit_control_flow__L10"
logic [8:0] pyc_zext_7; // op=pyc.zext
logic [8:0] pyc_zext_8; // op=pyc.zext
logic [8:0] pyc_not_9; // op=pyc.not
logic [8:0] pyc_add_10; // op=pyc.add
logic [8:0] pyc_add_11; // op=pyc.add
logic pyc_extract_12; // op=pyc.extract
logic [7:0] pyc_add_13; // op=pyc.add
logic [7:0] x__jit_control_flow__L12; // pyc.name="x__jit_control_flow__L12"
logic [7:0] pyc_add_14; // op=pyc.add
logic [7:0] x__jit_control_flow__L14; // pyc.name="x__jit_control_flow__L14"
logic [7:0] pyc_mux_15; // op=pyc.mux
logic [7:0] x__jit_control_flow__L11; // pyc.name="x__jit_control_flow__L11"
logic [7:0] acc__jit_control_flow__L16; // pyc.name="acc__jit_control_flow__L16"
logic [7:0] pyc_add_16; // op=pyc.add
logic [7:0] acc__jit_control_flow__L18; // pyc.name="acc__jit_control_flow__L18"
logic [7:0] pyc_add_17; // op=pyc.add
logic [7:0] acc__jit_control_flow__L18_2; // pyc.name="acc__jit_control_flow__L18"
logic [7:0] pyc_add_18; // op=pyc.add
logic [7:0] acc__jit_control_flow__L18_3; // pyc.name="acc__jit_control_flow__L18"
logic [7:0] pyc_add_19; // op=pyc.add
logic [7:0] acc__jit_control_flow__L18_4; // pyc.name="acc__jit_control_flow__L18"
logic [7:0] acc__jit_control_flow__L17; // pyc.name="acc__jit_control_flow__L17"
