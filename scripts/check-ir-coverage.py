#!/usr/bin/env python3
"""Enforce complete ACIR and ACSim v0.1 public IR coverage.
...
- docs/implementation/spec-coverage.md is the up-to-date generated ledger.
...
EPOCH = "0.1"
LEDGER_PATH = "docs/implementation/spec-coverage.md"

DIALECTS = {
    "acir": {
        "manifest": "contracts/acir-v0.1.yaml",
    ...
    "acsim": {
        "manifest": "contracts/acsim-v0.1.yaml",
