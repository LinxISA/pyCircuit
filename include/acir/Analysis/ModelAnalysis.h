...
public:
  ...
  /// Returns the SHA-256 of canonical topology-only state. Process bodies are
  /// deliberately excluded because continuation lowering is post-freeze and
  /// is not a topology mutation.
