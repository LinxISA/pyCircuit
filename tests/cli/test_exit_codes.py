...
class ExitCodeTest(unittest.TestCase):
    def test_internal_tool_failure_is_three(self) -> None:
        ...
        self.assertEqual("agentic-circuit-diagnostic", diagnostic["schema"])
        self.assertEqual("ACPY-INTERNAL-001", diagnostic["code"])
