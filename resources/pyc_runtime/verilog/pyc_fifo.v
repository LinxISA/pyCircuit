...
module pyc_fifo #(
  ...
  // Keep comparisons in the pointer/count widths.  Unsized integer
  // parameters otherwise trigger width expansion warnings in Verilator and
  // obscure truncation bugs when this primitive is parameterized.
