...
builtin.module attributes {ac.contract_epoch = "0.2"} {
  ...
  %completed = ac.dependency %input capacity 16 no_dependency 255 depth 8 latency 1 key {
  ^key(%item: !ac.var<i8>):
...
// CHECK: ac.dependency
// CHECK: capacity 16 no_dependency 255 depth 8 latency 1
// CHECK-COUNT-3: ac.dependency.yield
