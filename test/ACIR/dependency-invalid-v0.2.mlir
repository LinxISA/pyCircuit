...
// CAPACITY: error: 'ac.dependency' op capacity, depth, and latency must be positive
...
builtin.module attributes {ac.contract_epoch = "0.2"} {
  ...
  %bad = ac.dependency %input capacity 0 no_dependency 255 depth 1 latency 1 key {
...
builtin.module attributes {ac.contract_epoch = "0.2"} {
  %input = ac.source depth 1 latency 1 : !ac.queue<i8>
  %bad = ac.dependency %input capacity 4 no_dependency 255 depth 1 latency 1 key {
  ^key(%item: !ac.var<i8>): ac.dependency.yield %item : !ac.var<i8>
  } waits_for {
  ^waits_for(%item: !ac.var<i8>): ac.dependency.yield %item : !ac.var<i8>
  } cost {
...
builtin.module attributes {ac.contract_epoch = "0.2"} {
  ...
  %bad = ac.dependency %input capacity 4 no_dependency 16 depth 1 latency 1 key {
