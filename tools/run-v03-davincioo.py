#!/usr/bin/env python3
"""Run the generated v0.3 DavinciOO gfsim on one canonical PTO trace."""
...
from examples.v03.davincioo_jit import specialization  # noqa: E402
...
DEFAULT_PROJECTION = ROOT / "examples/v02/davincioo-softmax-projection.json"
HARNESS = ROOT / "examples/v03/davincioo_trace_harness.cpp"
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=ROOT / "build/v03-davincioo-trace"
    )
    ...
    report = {
        "schema": "agentic-circuit-v03-davincioo-run",
        "version": "0.1",
        "contract_epoch": "0.3",
