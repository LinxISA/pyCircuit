...
def select_pc(m: Circuit, *, seq_pc: Wire, redirect_valid: Wire, redirect_pc: Wire, flush_valid: Wire, flush_pc: Wire) -> F0Out:
    ...
    pc = redirect_pc if redirect_valid else seq_pc
    pc = flush_pc if flush_valid else pc
