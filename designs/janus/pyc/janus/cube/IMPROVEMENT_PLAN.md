...
**Tasks:**
- [ ] Create `flows/tools/cube_trace_diff.py` (inspired by linx-isa-emulator)
...
**Tasks:**
- [ ] Create `designs/janus/flows/tools/cube_regression.sh`
...
**Done means:**
- `bash designs/janus/flows/tools/cube_regression.sh` runs all validation
...
**Tasks:**
- [ ] Modify `designs/janus/pyc/designs/janus/top.py` to include Cube
...
- Command: `bash designs/janus/flows/tools/run_janus_cube_pyc_cpp.sh`
- Result: PASS (testIdentity, testSimple2x2)
- Evidence: [designs/janus/tb/tb_janus_cube_pyc.cpp](../tb/tb_janus_cube_pyc.cpp)

### Gate A2: Cube Verilog Generation Pass
**Status:** ✅ DONE (2026-02-10)
- Command: `bash designs/janus/update_generated.sh`
- Result: PASS (generates janus_cube_pyc.v ~48MB, janus_cube_pyc_gen.hpp ~51MB)
- Evidence: [designs/janus/generated/janus_cube_pyc/](../../generated/janus_cube_pyc/)
...
**Status:** ⏳ BLOCKED
- Command: `python3 flows/tools/cube_trace_diff.py --cpp trace_cpp.csv --rtl trace_rtl.csv`
...
**Status:** ⏳ NOT STARTED
- Command: `bash designs/janus/flows/tools/cube_regression.sh --stage tests`
- Blocker: Additional tests not implemented
- Target: Phase 3 completion

### Gate B2: Cube Regression Pass
**Status:** ⏳ NOT STARTED
- Command: `bash designs/janus/flows/tools/cube_regression.sh`
- Blocker: Regression script not created
- Target: Phase 4 completion

### Gate C1: Janus+Cube Integration Pass
**Status:** ⏳ NOT STARTED
- Command: `bash designs/janus/flows/tools/run_janus_with_cube_cpp.sh`
