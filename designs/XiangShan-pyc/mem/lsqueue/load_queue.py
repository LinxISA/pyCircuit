...
def load_queue(
    ...
    *,
    ...
    e_addr_valid = domain.signal(width=1, shape=[size], reset_value=0, name=f"{prefix}_lq_av")
    e_committed = domain.signal(width=1, shape=[size], reset_value=0, name=f"{prefix}_lq_cm")
    e_addr = domain.signal(width=addr_width, shape=[size], reset_value=0, name=f"{prefix}_lq_a")
    e_rob = domain.signal(width=rob_idx_width, shape=[size], reset_value=0, name=f"{prefix}_lq_r")
