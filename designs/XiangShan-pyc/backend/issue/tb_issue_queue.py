...
def _compile_iq(*, entries: int = ENTRIES, name: str = "iq_s", issue_ports: int = ISSUE_P):
...
def tb_issue_queue_functional(t: Tb) -> None:
    ...
    tb.expect("iq_issue_valid", [0], phase="pre", msg="T3: previous op drained; enqueue cycle")
