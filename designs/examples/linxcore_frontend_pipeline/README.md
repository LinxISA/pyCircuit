...
```bash
PYTHONPATH=compiler/frontend python3 -m pytest -q \
  tests/unit/test_linxcore_frontend_pipeline.py

PYTHONPATH=compiler/frontend python3 -m pycircuit.cli build \
  designs/examples/linxcore_frontend_pipeline/tb_linxcore_frontend_pipeline.py \
