...
from bypass_unit_v5 import PTYPE_P, bypass_unit  # noqa: E402
...
def tb(t: Tb) -> None:
    ...
    tb.expect("bp_i2_srcL_data", _pack([0x3333, 0, 0, 0], DATA_W), msg="v5 data")
    tb.expect("bp_i2_srcL_hit", _pack([1, 0, 0, 0], 1), msg="v5 hit")
    tb.expect("bp_i2_srcL_sel_stage", _pack([1, 0, 0, 0], 2), msg="v5 stage")
    tb.expect("bp_i2_srcL_sel_lane", _pack([3, 0, 0, 0], LANE_W), msg="v5 lane")
    tb.finish()
