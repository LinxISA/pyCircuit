...
extract test/Transforms/freeze-topology.mlir valid.mlir "$TMP/freeze-valid.mlir"
extract test/Transforms/deterministic-canonicalization.mlir a.mlir "$TMP/detcanon-a.mlir"
extract test/Transforms/deterministic-canonicalization.mlir b.mlir "$TMP/detcanon-b.mlir"
