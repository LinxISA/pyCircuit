...
std::string harnessTrace() {
  return R"json({"schema":"pto-trace","version":"0.1","contract_epoch":"0.3","metadata":{"record_count":0},"records":[]})json";
}

std::string harnessTraceWithOneRecord() {
  return R"json({"schema":"pto-trace","version":"0.1","contract_epoch":"0.3","metadata":{"record_count":1},"records":[{"sequence_id":17,"opcode":"pto.test","operands":[],"dependencies":[],"attributes":{}}]})json";
}
...
std::string harnessRunManifest(std::string_view buildHash,
  ...
  return "{\"schema\":\"agentic-circuit-run-manifest\",\"version\":\"0.1\","
         "\"contract_epoch\":\"0.3\",\"build_manifest\":{\"path\":"
...
TEST(GfsimTraceTest, RejectsForwardDependencyWithStableDiagnostic) {
  constexpr std::string_view invalid = R"json({
    "schema":"pto-trace","version":"0.1","contract_epoch":"0.3",
    "metadata":{},"records":[
...
TEST(GfsimTraceTest, ValidatesDuplicateKeysRecordCountAndContentHash) {
  ...
  constexpr std::string_view duplicateKey = R"json({
    ...
    "contract_epoch":"0.3","metadata":{},"records":[]})json";
